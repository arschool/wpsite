...
<script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=AIzaSyBVCaQrq0b5p529aFLcbQQvjjybzJq1VPk&&callback=googleMapsInit" async defer></script>
EOF;
echo $googleMapsJs;
?>
